										...
										<?php
											try {
										        ...
										        if ($cont!=0){
										        	...
										        	<form action="reservaClienteNuevo.php" method="post" class="w3_form_post"  name="formulario" >
														<div class="w3_agileits_main_grid w3l_main_grid">
															<div class="agileits_grid">
			...
			<div class="modal fade" id="myModal3" tabindex="-1" role="dialog">
						<!-- Modal2 -->
							...
							<!-- Modal content-->
								<div class="modal-content">
									<div class="modal-header">
										<button type="button" class="close" data-dismiss="modal" id="cerrar1">&times;</button>
										<?php
											try {
											    $wsdl_url = "http://localhost:8080/HotelServidor/Hotel?WSDL";
											    $client = new SOAPClient($wsdl_url);
										        ...
										        if ($cont!=0){
										        	...
										        	<form action="reserva.php" method="post" class="w3_form_post"  name="formulario3" >
														<div class="w3_agileits_main_grid w3l_main_grid">
															<div class="agileits_grid">
																<h5 class="w3_main_grid_left">Cedula *</h5>
																<br>
																<br>
																<input type="number" id="Cedula1" name="Cedula1" placeholder="0000000000" required="">
															</div>
														</div>
															...
															<div class="wthree_grid">
																...
																<?php
																	try {
																	    ...
																	    $params = array();
																	    $return = $client->ListarHabitaciones($params);							
																		echo "<select id='idHabitacion1' name='idHabitacion1' required=''>";
																		foreach ($return as $res){
																            $con=count($return->return);
															            	for($i=0;$i<$con;$i++){   
																            	if ($return->return[$i]->estado=='Desocupada'){             
																	                echo "<option name='idHabitacion1' value='";
																	                echo $return->return[$i]->id;
																	                echo "'>";
																	                echo $return->return[$i]->id;
																	                echo "  ";
														...
														<div class="agileits_w3layouts_main_grid w3ls_main_grid">
															...
															<h5 class="w3_main_grid_left">Dia Entrada *</h5>
																...
																<br>
																<div class="agileits_w3layouts_main_gridl">
																	<input class="date" id="diaEntrada1" name="diaEntrada1" type="text" value="yyyy/mm/dd" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '';}" required="">
																</div>
																<div class="clearfix"> </div>
															</div>
														</div>
														<div class="agileits_w3layouts_main_grid w3ls_main_grid">
															...
															<h5 class="w3_main_grid_left">Dia Salida *</h5>
																...
																<br>
																<div class="agileits_w3layouts_main_gridl">
																	<input class="date" id="diaSalida1" name="diaSalida1" type="text" value="yyyy/mm/dd" onfocus="this.value = '';" onblur="if (this.value == '') {this.value ='';}" required="">
																</div>
																<div class="clearfix"> </div>
															</div>
														</div>												
		...
		<script type="text/javascript">
			...
			$('#button1').on('click', function(event) {
				event.preventDefault();
					...
					Cedula = document.formulario3.Cedula1.value;
					diaEntrada = document.formulario3.diaEntrada1.value;
			...
			$('#volver').on('click', function(event) {
				...
				document.formulario.idHabitacion.value='';
				document.formulario.diaSalida.value='';
				document.formulario3.Cedula1.value="";
				document.formulario3.diaEntrada1.value='';
				document.formulario3.diaSalida1.value='';
				document.formulario3.idHabitacion1.value='';
				document.getElementById('main').value ='';
				document.getElementById('main3').value ='';
			});
